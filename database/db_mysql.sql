...
DROP DATABASE IF EXISTS YL_PHP_MVC_TEMPLATE_PROJ;
DROP USER IF EXISTS 'YL_PHP_MVC_TEMPLATE_PROJ_USER'@'localhost';
-- ---------------------------------------------------------------------------------------------

-- ---------------------------------------------------------------------------------------------
-- Create Database

CREATE DATABASE IF NOT EXISTS YL_PHP_MVC_TEMPLATE_PROJ;
-- ---------------------------------------------------------------------------------------------

-- ---------------------------------------------------------------------------------------------
-- Create User & Grant Permissions
-- We create localhost user ('127.0.0.1' is used just in case IPv6 is detected).


CREATE USER 'YL_PHP_MVC_TEMPLATE_PROJ_USER'@'localhost' IDENTIFIED BY 'password';

GRANT ALL ON YL_PHP_MVC_TEMPLATE_PROJ.* TO 'YL_PHP_MVC_TEMPLATE_PROJ_USER'@'localhost';
